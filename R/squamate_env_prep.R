...
squamates <- read_rds("output/squamate_final_data_w_env_samps.rds")
...
write_csv(squamate_train, "output/squamate_training.csv")
write_csv(squamate_test, "output/squamate_testing.csv")
